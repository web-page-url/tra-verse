...
// Mock itinerary generator for development when Gemini API is unavailable
function generateMockItinerary(tripRequest: TripRequest): TripResponse {
  ...
  console.log('🎭 Generating mock itinerary for development...');
