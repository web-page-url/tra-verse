      ...
      <div className="relative z-10">
        ...
        <header className="flex justify-between items-center p-4 sm:p-6 backdrop-blur-md bg-black/80 border-b border-cyan-400/30 relative overflow-hidden">
          ...
          <nav className="hidden md:flex space-x-6 lg:space-x-8 relative z-10">
            ...
            <Link href="/about" className="cursor-target text-green-400 hover:text-cyan-400 transition-all duration-300 hover:scale-110 font-mono text-xs sm:text-sm tracking-wider relative group cursor-pointer">
              [ABOUT]
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-400 group-hover:w-full transition-all duration-300 animate-pulse-glow-slow"></span>
            </Link>
        ...
        {/* Enhanced Footer */}
        <footer className="py-12 px-6 border-t border-white/10 backdrop-blur-md bg-white/5">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <a
                  href="/about"
                  className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-300 font-medium text-sm group cursor-target"
                >
                  Learn More About Us
            ...
            <div className="pt-8 border-t border-white/10 mt-8 text-center">
